 ...
 *   - "down_payment_managerial"   : Down Payment থেকে Team management Commission
 *   - "installment_managerial"    : Installment থেকে Team management Commission
 */
...
const PendingCommissionSchema = new Schema<IPendingCommission>(
  {
    ...
    type: {
      type: String,
      enum: ["down_payment_managerial", "installment_managerial"],
      required: true,
    },
