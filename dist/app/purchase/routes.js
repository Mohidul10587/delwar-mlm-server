...
router.get("/:id/receipt/download", auth_1.verifyUser, controller_1.downloadPurchaseReceipt);
...
router.get("/:purchaseId/installments/:installmentId/receipt/download", auth_1.verifyUser, controller_1.downloadInstallmentReceipt);
