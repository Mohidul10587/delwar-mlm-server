...
function staffName(rb) {
  ...
  return (_b = (_a = rb.name) !== null && _a !== void 0 ? _a : rb.username) !==
    null && _b !== void 0
    ? _b
    : "—";
}
...
function buildReceiptHtml(data) {
    ...
    (_d =
      (_b =
        (_a = purchase.snapshot) === null || _a === void 0
          ? void 0
          : _a.shareTitle) !== null && _b !== void 0
        ? _b
        : (_c = purchase.projectId) === null || _c === void 0
        ? void 0
  ...
  const cashPrice =
    (_h =
      (_f =
        (_e = purchase.snapshot) === null || _e === void 0
          ? void 0
          : _e.cashPrice) !== null && _f !== void 0
        ? _f
        : (_g = purchase.projectId) === null || _g === void 0
        ? void 0
        : _g.cashPrice) !== null && _h !== void 0
      ? _h
      : 0;
  ...
  const buyerName =
    (_m =
      (_k =
        (_j = purchase.buyerInfo) === null || _j === void 0
          ? void 0
          : _j.name) !== null && _k !== void 0
        ? _k
        : (_l = purchase.userId) === null || _l === void 0
        ? void 0
  ...
  const buyerPhone =
    (_r =
      (_p =
        (_o = purchase.buyerInfo) === null || _o === void 0
          ? void 0
          : _o.phone) !== null && _p !== void 0
        ? _p
        : (_q = purchase.userId) === null || _q === void 0
        ? void 0
        : _q.phone) !== null && _r !== void 0
      ? _r
      : "—";
  const buyerCustomerId =
    (_t =
      (_s = purchase.userId) === null || _s === void 0
        ? void 0
        : _s.customerId) !== null && _t !== void 0
      ? _t
      : "—";
  const nominees = (() => {
    ...
    if (
      (_b =
        (_a = purchase.buyerInfo) === null || _a === void 0
          ? void 0
          : _a.nominees) === null || _b === void 0
        ? void 0
        : _b.length
    )
    ...
    if (
      (_d =
        (_c = purchase.buyerInfo) === null || _c === void 0
          ? void 0
          : _c.nominee) === null || _d === void 0
        ? void 0
        : _d.name
    )
    ...
    if (
      (_f =
        (_e = purchase.buyerInfo) === null || _e === void 0
          ? void 0
          : _e.nominee2) === null || _f === void 0
        ? void 0
        : _f.name
    )
  ...
  const paymentDate = isInstallmentReceipt
    ? (_u = installment.reviewedAt) !== null && _u !== void 0
      ? _u
      : installment.createdAt
    : (_v = purchase.reviewedAt) !== null && _v !== void 0
    ? _v
    : purchase.createdAt;
  ...
  const shareNoDisplay =
    (_w =
      shareNumbers === null || shareNumbers === void 0
        ? void 0
        : shareNumbers.join(", ")) !== null && _w !== void 0
      ? _w
      : "—";
...
function generateReceiptPng(data) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      yield page.setContent(buildReceiptHtml(data), {
