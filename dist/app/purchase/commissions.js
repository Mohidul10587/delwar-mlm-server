...
exports.distributeInstallmentPaymentCommission = exports.distributeCommissions =
  void 0;
...
const atomicCreditWallet = (userId, field, amount) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const wallet = yield model_2.Wallet.findOneAndUpdate(
      { userId },
...
const ledgerCommission = (txId, userId, amount, note) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const distributeCommissions = (purchaseId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f;
    try {
      const purchase = yield model_1.Purchase.findOneAndUpdate(
      ...
      if (!snap) return;
      const buyer = yield model_3.User.findById(purchase.userId).select(
        "generationAncestors name username"
      );
      if (!buyer) return;
      // C-04 fix: load Settings once and pass to all recalcUserRank calls
      const { Settings } = yield Promise.resolve().then(() =>
        __importStar(require("../settings/model"))
      );
      const settingsDoc = yield Settings.findOne();
      const preloadedRanks =
        (_a =
          settingsDoc === null || settingsDoc === void 0
            ? void 0
            : settingsDoc.ranks) !== null && _a !== void 0
          ? _a
          : [];
      const buyerName = (_b = buyer.name) !== null && _b !== void 0 ? _b : "";
      const buyerUsername =
        (_c = buyer.username) !== null && _c !== void 0 ? _c : "";
      const shareTitle =
        (_d = snap.shareTitle) !== null && _d !== void 0 ? _d : "";
      const qty = purchase.quantity;
      const payType = purchase.paymentType === "cash" ? "Cash" : "Installment";
      const referrerId =
        (_f =
          (_e = buyer.generationAncestors[0]) === null || _e === void 0
            ? void 0
            : _e.userId) !== null && _f !== void 0
          ? _f
          : null;
      ...
      if (purchase.paymentType === "cash") {
        downPaymentPortion =
          Math.min(snap.maxDownPayment, snap.cashPrice) * qty;
        installmentPortion =
      ...
      if (referrerId) {
        ...
        if (commission > 0) {
          const wallet = yield atomicCreditWallet(
            referrerId.toString(),
        ...
        yield (0, controller_1.recalcUserRank)(
          referrerId.toString(),
          preloadedRanks
        ); // C-04 fix
      }
...
const distributeInstallmentPaymentCommission = (
  purchaseId,
  installmentAmount,
  installmentNo
) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const buyerUsername =
        (_b = buyer.username) !== null && _b !== void 0 ? _b : "";
      const shareTitle =
        (_c = snap.shareTitle) !== null && _c !== void 0 ? _c : "";
...
exports.distributeInstallmentPaymentCommission =
  distributeInstallmentPaymentCommission;
