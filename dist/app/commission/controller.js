...
const triggerTeamCommission = (_req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const processed = yield (0, cron_1.runTeamCommissionCron)();
      res.json({
        message: {
          en: "Team commission processed",
          bn: "টিম কমিশন প্রসেস হয়েছে",
        },
        processed,
      });
    } catch (err) {
...
const triggerManagerialCommission = (_req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const processed = yield (0, cron_1.runManagerialCommissionCron)();
      res.json({
        message: {
          en: "Team management commission transferred",
          bn: "ম্যানেজারিয়াল কমিশন ট্রান্সফার হয়েছে",
        },
        processed,
      });
    } catch (err) {
