...
const createShare = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const pkg = yield model_1.Share.create(req.body);
      res.status(201).json({
        message: { en: "Share created", bn: "প্যাকেজ তৈরি হয়েছে" },
        pkg,
      });
    } catch (err) {
      next(err);
...
const updateShare = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const pkg = yield model_1.Share.findByIdAndUpdate(
        req.params.id,
        { $set: req.body },
